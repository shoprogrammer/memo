...
from memo.models import MemoModel
from django.forms.widgets import Select

public_choices = ((0, "全て"), (1, "公開済のみ"), (2, "ドラフトのみ"))

class MemoModelFilter(django_filters.FilterSet):
    #公開・非公開を入力
    ...
    #プロフィールパラメータ
    profile = django_filters.NumberFilter(method="get_profile_memo")
    ...
    def get_profile_memo(self, queryset, name,value):
